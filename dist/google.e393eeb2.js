...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"google.js":[function(require,module,exports) {
"use strict";
...
var getPagesURL; // let results = document.getElementById("results");

var results = document.getElementById("gesture-area");
...
function search() {
  ...
  for (var i = 0; i < numOfPages; i++) {
    var _pageNum = Math.floor(Math.random() * 90) + 1;

    console.log(_pageNum);
    getPagesURL = "https://www.googleapis.com/customsearch/v1?key=AIzaSyBuzXX0QdY0l4BXgKXkgn-pBur-bRRZ8sQ&cx=001890896498940584054:ltxzdnhqnbk&q=".concat(query, "&searchType=image&start=").concat(_pageNum);
    request(getPagesURL).then(function (data) {
      ...
      photoList.forEach(function (photoInfo, i) {
        results.innerHTML += "<img src=\"".concat(photoInfo.link, "\" id=\"scale-element").concat(i, "\" style=\"width: 200px;\">");
      });
      var resizableObjs = document.getElementsByClassName("resizable"); // console.log("resizableObjs:");
      // console.log(resizableObjs);
      // console.log("resizableObjs length = " + resizableObjs.length);

      for (var _i = 0; _i < resizableObjs.length; _i++) {
        console.log("resizableObj #" + _i + ": ");
        console.log(resizableObjs[_i]);

        resizableObjs[_i].addEventListener('touchstart', function () {
          console.log('touching');
        });

        mouseDragElement(resizableObjs[_i]);
        makeResizableDiv("#scale-element".concat(_i));
      }
    });
  }
}
...
;
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","google.js"], null)
//# sourceMappingURL=/google.e393eeb2.js.map